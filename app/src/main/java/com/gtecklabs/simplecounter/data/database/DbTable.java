...
public class DbTable {
   ...
   * @param f Columns to create as part of the table
   */
   ...
   * @param n       The name of the table
   * @param f       Columns to create as part of the table
   * @param indexes Indexes to create on this table
   */
  ...
  public static class Builder {
     ...
     *
     * @param columns The columns to be created with the table (in order)
     ...
     * Set the columns which will be created on the new table
     *
     * @param indexes The indexes to create on this table
     * @return <code>this</code> object (for chaining)
     */
