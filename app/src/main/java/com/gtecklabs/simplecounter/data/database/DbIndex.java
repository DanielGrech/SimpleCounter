...
public class DbIndex {
   ...
   * @param isUnique Whether this index has a unique constraint or not
   * @param columns  The fields to create the index on
   */
  ...
  /**
   * @param tableName The name of the table to add this index too
  ...
  public static class Builder {
     ...
     *
     * @param indexName The name of the new index to create
    ...
    /**
     * @param columns The columns to be created with the index
     * @return <code>this</code> object (for chaining)
     */
